                        ...
                        >
                            <div className='w-[280px] text-sm'>
                                {visibility_list.map((item,i) => (
                                    <button key={i} onClick={() => setVisibility(item.value)} className={clsx(`flex w-full cursor-pointer items-center p-2 hover:bg-blue-500/10 hover:text-blue-500 rounded-sm ${visibility === item.value ? 'bg-blue-500/10 text-blue-500' : ''}`)}>
